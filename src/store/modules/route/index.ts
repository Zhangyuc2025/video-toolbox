...
import { fetchGetConstantRoutes, fetchGetUserRoutes, fetchIsRouteExist } from '@/http/api';
...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
  ...
  async function initAuthRoute() {
    // No login required - directly init routes
    if (authRouteMode.value === 'static') {
      initStaticAuthRoute();
    } else {
  ...
  function initStaticAuthRoute() {
    ...
    // No login required - load all routes without role filtering
  ...
  async function onRouteSwitchWhenLoggedIn() {
    // No login required - no need to init user info
  }
