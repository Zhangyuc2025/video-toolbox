...
export const useAppStore = defineStore(SetupStoreId.App, () => {
  ...
  const { bool: siderCollapse, setBool: setSiderCollapse, toggle: toggleSiderCollapse } = useBoolean(localStg.get('siderCollapse') === 'Y');
  const {
    bool: mixSiderFixed,
  ...
  // cache mixSiderFixed and siderCollapse
  useEventListener(window, 'beforeunload', () => {
    localStg.set('mixSiderFixed', mixSiderFixed.value ? 'Y' : 'N');
    localStg.set('siderCollapse', siderCollapse.value ? 'Y' : 'N');
  });
